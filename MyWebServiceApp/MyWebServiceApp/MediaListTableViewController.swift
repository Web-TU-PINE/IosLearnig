...
class MediaListTableViewController: UITableViewController {
    ...
    //เมื่อผู้ใช้กดเลือกที่แต่ละ Row
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.section == 0{
            ...
            let alertController = UIAlertController(title: "AVPlayer", message: "กําลังเล่นเพลง " + myAVItem["avName"]! + " " +
                myAVItem["artistName"]!, preferredStyle: .actionSheet)
            ...
            if let player = moviePlayer {
                NotificationCenter.default.addObserver(self, selector: #selector(videoHasFinishedPlaying), name: Notification.Name.AVPlayerItemDidPlayToEndTime, object: nil)
