...
class MainTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        //กําหนดข้อความไว้ในส่วนของ Navigation
        ...
        let myFriend2 : ContactInformation =
            ContactInformation(contactName: "เอมมี่ ศรีประเสริฐ", contactNickName:
                "เอม", contactPhoneNumber: "095-123-4567", contactType: 1,
                             contactPublicType: 0, contactImage: UIImage(named: "g1.png")!)
        let myFriend3 : ContactInformation =
            ContactInformation(contactName: "มาลินี สุขใจ", contactNickName: "มะลิ",
                               contactPhoneNumber: "02-123-4567", contactType: 2,
                               contactPublicType: 1, contactImage: UIImage(named: "g2.png")!)
        let myFriend4 : ContactInformation =
            ContactInformation(contactName: "กิตติ คนดี", contactNickName: "กิต",
                               contactPhoneNumber: "081-987-6543", contactType: 3,
                               contactPublicType: 1, contactImage: UIImage(named: "b2.png")!)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.imageView?.image = 
            myContactInfoList[indexPath.row].contactImage
